...
integer*4  :: ntot      = -123 ! max. number of time steps
integer*4  :: nout      = -123 ! time step interval output
real*8     :: hmin      = -123 ! threshold water depth 
real*8     :: hmax      = -123 ! determine maximum water depth
...
par%smax     = readkey_dbl ('params.txt','smax',   0.8d0,    0.d0,   3.d0)       !changed 28/11
